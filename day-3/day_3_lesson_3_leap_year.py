...
If english is not your first language or if the above logic is confusing, try using this flow chart (https://shorturl.at/FHIQX) .
...
year = int(input(f"Enter the year you want to check: "))
